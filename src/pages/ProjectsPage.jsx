...
const ALL_PROJECTS = [
  {
    ...
    photos: [
      { src: `${base}projects/kuttanad/kuttanad1.png`, alt: "Exterior — Front",  fallbackBg: "linear-gradient(135deg,#1a2a1a,#2d3d20,#1a2510)" },
      { src: `${base}projects/kuttanad/kuttanad2.png`, alt: "Courtyard",         fallbackBg: "linear-gradient(160deg,#12201a,#223a28,#0e1a10)" },
      { src: `${base}projects/kuttanad/kuttanad3.png`, alt: "Garden View",       fallbackBg: "linear-gradient(120deg,#0e1c0e,#1e3016,#0a120a)" },
      { src: `${base}projects/kuttanad/kuttanad4.png`, alt: "Verandah",          fallbackBg: "linear-gradient(145deg,#0e1c0e,#1a2e12,#0a1408)" },
      { src: `${base}projects/kuttanad/kuttanad5.png`, alt: "River Facing",      fallbackBg: "linear-gradient(130deg,#0c1a0c,#182a10,#081208)" },
      { src: `${base}projects/kuttanad/kuttanad6.png`, alt: "Interior Living",   fallbackBg: "linear-gradient(155deg,#101e10,#1c3014,#0c1409)" },
    ],
    heroImage: `${base}projects/kuttanad/kuttanad1.png`,
  ...
  },
  {
    ...
    photos: [
      { src: `${base}projects/kakkanad/kakkanad1.png`, alt: "Facade — Night",      fallbackBg: "linear-gradient(135deg,#0d1520,#1a2535,#0a1018)" },
      { src: `${base}projects/kakkanad/kakkanad2.png`, alt: "Living Spaces",        fallbackBg: "linear-gradient(150deg,#0a1220,#16222e,#080e18)" },
    ],
    heroImage: `${base}projects/kakkanad/kakkanad1.png`,
  ...
  },
  {
    ...
    photos: [
      { src: `${base}projects/calicut/calicut1.png`, alt: "Site Perspective", fallbackBg: "linear-gradient(135deg,#1a1010,#2d1a10,#1a0f08)" },
      { src: `${base}projects/calicut/calicut2.png`, alt: "Section View",     fallbackBg: "linear-gradient(150deg,#150c0c,#251610,#100a06)" },
      { src: `${base}projects/calicut/calicut3.png`, alt: "Entry Court",      fallbackBg: "linear-gradient(120deg,#120a08,#1e1208,#0c0806)" },
    ],
    heroImage: `${base}projects/calicut/calicut1.png`,
  ...
  },
  {
    ...
    photos: [
      { src: `${base}projects/perinthalmanna/perinthalmanna1.png`, alt: "Exterior",        fallbackBg: "linear-gradient(135deg,#1a2010,#283018,#151a0c)" },
      { src: `${base}projects/perinthalmanna/perinthalmanna2.png`, alt: "Roof Detail",     fallbackBg: "linear-gradient(150deg,#141a0e,#202814,#0e120a)" },
      { src: `${base}projects/perinthalmanna/perinthalmanna3.png`, alt: "Landscape",       fallbackBg: "linear-gradient(120deg,#101608,#1c2210,#0c1006)" },
      { src: `${base}projects/perinthalmanna/perinthalmanna4.png`, alt: "Shaded Openings", fallbackBg: "linear-gradient(145deg,#121808,#1e2612,#0e1408)" },
    ],
    heroImage: `${base}projects/perinthalmanna/perinthalmanna1.png`,
  ...
  },
  {
    ...
    photos: [
      { src: `${base}projects/annara/annara1.png`, alt: "Courtyard",     fallbackBg: "linear-gradient(135deg,#101520,#181f2a,#0c1018)" },
      { src: `${base}projects/annara/annara2.png`, alt: "Staircase",     fallbackBg: "linear-gradient(150deg,#0c1018,#141a24,#080c14)" },
      { src: `${base}projects/annara/annara3.png`, alt: "Bedroom Wing",  fallbackBg: "linear-gradient(120deg,#080e16,#10161e,#060a10)" },
      { src: `${base}projects/annara/annara4.png`, alt: "Sky Opening",   fallbackBg: "linear-gradient(145deg,#0a1018,#121820,#06080e)" },
    ],
    heroImage: `${base}projects/annara/annara1.png`,
  ...
  },
  {
    ...
    photos: [
      { src: `${base}projects/steam-mugs/steam-mugs1.png`, alt: "Interior",       fallbackBg: "linear-gradient(135deg,#1a1508,#2a2010,#150f05)" },
      { src: `${base}projects/steam-mugs/steam-mugs2.png`, alt: "Shutter Wall",   fallbackBg: "linear-gradient(150deg,#161208,#22180c,#100d04)" },
      { src: `${base}projects/steam-mugs/steam-mugs3.png`, alt: "Bar Counter",    fallbackBg: "linear-gradient(120deg,#120e06,#1c1408,#0c0a04)" },
    ],
    heroImage: `${base}projects/steam-mugs/steam-mugs1.png`,
  ...
  },
  {
    ...
    photos: [
      { src: `${base}projects/thrissur/thrissur1.png`, alt: "Street View",       fallbackBg: "linear-gradient(135deg,#080d18,#101828,#060a12)" },
      { src: `${base}projects/thrissur/thrissur2.png`, alt: "Commercial Level",  fallbackBg: "linear-gradient(150deg,#060a14,#0e1422,#04080e)" },
    ],
    heroImage: `${base}projects/thrissur/thrissur1.png`,
  ...
  },
  {
    ...
    photos: [
      { src: `${base}projects/wayanad/wayanad1.png`,  alt: "Entrance",      fallbackBg: "linear-gradient(135deg,#0a1a10,#122518,#08120c)" },
      { src: `${base}projects/wayanad/wayanad2.png`,  alt: "Lounge Area",   fallbackBg: "linear-gradient(150deg,#081510,#0e1e14,#060e0a)" },
      { src: `${base}projects/wayanad/wayanad3.png`,  alt: "Dormitory",     fallbackBg: "linear-gradient(120deg,#060e0a,#0a1810,#040c08)" },
      { src: `${base}projects/wayanad/wayanad4.png`,  alt: "Green Wall",    fallbackBg: "linear-gradient(145deg,#081812,#0e2016,#060e0c)" },
      { src: `${base}projects/wayanad/wayanad5.png`,  alt: "Stone Detail",  fallbackBg: "linear-gradient(130deg,#0a1a10,#101e14,#080e0a)" },
      { src: `${base}projects/wayanad/wayanad6.png`,  alt: "Timber Deck",   fallbackBg: "linear-gradient(155deg,#081610,#0c1c14,#060e0a)" },
      { src: `${base}projects/wayanad/wayanad7.png`,  alt: "Courtyard",     fallbackBg: "linear-gradient(135deg,#0a1a10,#122518,#08120c)" },
      { src: `${base}projects/wayanad/wayanad8.png`,  alt: "Seating",       fallbackBg: "linear-gradient(150deg,#081510,#0e1e14,#060e0a)" },
      { src: `${base}projects/wayanad/wayanad9.png`,  alt: "Exterior",      fallbackBg: "linear-gradient(120deg,#060e0a,#0a1810,#040c08)" },
      { src: `${base}projects/wayanad/wayanad10.png`, alt: "Reception",     fallbackBg: "linear-gradient(145deg,#081812,#0e2016,#060e0c)" },
      { src: `${base}projects/wayanad/wayanad11.png`, alt: "Corridor",      fallbackBg: "linear-gradient(130deg,#0a1a10,#101e14,#080e0a)" },
      { src: `${base}projects/wayanad/wayanad12.png`, alt: "Bath",          fallbackBg: "linear-gradient(155deg,#081610,#0c1c14,#060e0a)" },
      { src: `${base}projects/wayanad/wayanad13.png`, alt: "Bedroom",       fallbackBg: "linear-gradient(135deg,#0a1a10,#122518,#08120c)" },
      { src: `${base}projects/wayanad/wayanad14.png`, alt: "Night View",    fallbackBg: "linear-gradient(150deg,#081510,#0e1e14,#060e0a)" },
      { src: `${base}projects/wayanad/wayanad15.png`, alt: "Dining",        fallbackBg: "linear-gradient(120deg,#060e0a,#0a1810,#040c08)" },
      { src: `${base}projects/wayanad/wayanad16.png`, alt: "Pool Deck",     fallbackBg: "linear-gradient(145deg,#081812,#0e2016,#060e0c)" },
      { src: `${base}projects/wayanad/wayanad17.png`, alt: "Canopy",        fallbackBg: "linear-gradient(130deg,#0a1a10,#101e14,#080e0a)" },
      { src: `${base}projects/wayanad/wayanad18.png`, alt: "Landscape",     fallbackBg: "linear-gradient(155deg,#081610,#0c1c14,#060e0a)" },
    ],
    heroImage: `${base}projects/wayanad/wayanad1.png`,
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.pageHero}>
        ...
        <img src={`${base}studio/workspace.png`} alt="Our studio" className={styles.pageHeroImg} />
